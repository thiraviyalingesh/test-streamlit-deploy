...
# Optional: Set theme config in .streamlit/config.toml
...
<style>
    ...
    /* Dark background specific charts */
    .dark-chart {
        background-color: #1E1E1E;
    }
    ...
    /* Chart borders */
    .engagement-chart {
        border-left: 5px solid #1DA1F2;  /* Twitter blue */
    }
    ...
    /* Chart title for dark background */
    .dark-chart .chart-title {
        color: #FFFFFF;
        font-size: 1.5rem;
        font-weight: bold;
        margin-bottom: 20px;
...
def main():
    ...
    # Page header
    st.markdown("""
        <h1 style='color: #333333; text-align: center; padding: 20px 0;'>
    ...
    with col3:
        ...
        st.markdown('<div class="chart-container success-chart dark-chart">', unsafe_allow_html=True)
        ...
        fig_success = go.Figure(data=[go.Pie(
            ...
            hole=0.7,
            textinfo='none',
            marker=dict(colors=['#74c69d', '#e9ecef'])
        )])
